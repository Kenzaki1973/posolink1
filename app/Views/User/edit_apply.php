          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-body">
                ...
                <p><strong>Full Name:
                <input type="text" name="job_id" value="<?=$edit_apply['app_fullname']; ?>">
                </strong>
                </p>

                <p><strong>Email:
                <input type="text" name="emp_company" value="<?=$edit_apply['app_email']; ?>">
                </strong>
                 </p>
              
                <p><strong>Contact:
                <input type="text" name="job_id" value="<?=$edit_apply['app_contact']; ?>">
                </strong>
                 </p>
              
                <p><strong>Address:
                <input type="text" name="emp_company" value="<?=$edit_apply['app_address']; ?>">
                </strong>
                 </p>
              
              </div>
              <div class="card-footer">
                <a href="<?= site_url('/jobpost') ?>" class="btn btn-success">Update</a>
              </div>
            </div>
            <!-- /.card -->
          </div>
