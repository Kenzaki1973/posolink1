		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="<?= site_url('/log') ?>"  method="post" class="signin-form">
	          ...
	          <div class="social d-flex text-center">
	          	<a href="/applicantregistration" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span> Register</a>
	          </div>
		      </div>
				</div>
			</div>
